...
public class MaxTemperatureByStationNameUsingDistributedCacheFile extends
	...
	public static void main(String[] args) throws Exception {
		/*if(args == null || args.length != 3) {//stations-fixed-width.txt
			args = new String[] {
					"-files",
					"src/main/resources/input/ncdc/metadata/stations-fixed-width.txt",
					"src/main/resources/input/ncdc/all",
					"src/main/resources/08/join" };
		}*/
		//-files src/main/resources/input/ncdc/metadata/stations-fixed-width.txt src/main/resources/input/ncdc/all src/main/resources/08/join
